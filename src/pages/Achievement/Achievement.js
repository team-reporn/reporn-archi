      ...
      return(
        <View>
          ...
          <View style={{alignItems: "center", marginTop: -200, transform: [{scale: 0.6}]}}>
            <Image source={require('../../assets/img/stat/joueur1/Voyeurisme.png')}/>
            <Image source={require('../../assets/img/stat/joueur1/Expert.png')}/>
            <Image source={require('../../assets/img/stat/joueur1/Rapidite.png')}/>
          </View>
          <NextBtn onPress={() => {
    ...
    if (step == 0) {
      ...
      return(
        <View>
          ...
          <View style={{alignItems: "center", marginTop: -200, transform: [{scale: 0.6}]}}>
            <Image source={require('../../assets/img/stat/joueur2/Voyeurisme.png')}/>
            <Image source={require('../../assets/img/stat/joueur2/Expert.png')}/>
            <Image source={require('../../assets/img/stat/joueur2/Rapidite.png')}/>
          </View>
          <NextBtn onPress={() => {
                navigation.navigate("Futur", {
                  title: "Futur",
